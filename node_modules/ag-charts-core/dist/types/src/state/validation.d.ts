...
declare const enterpriseSymbol: unique symbol;
declare const deprecatedSymbol: unique symbol;
 ...
 */
export declare function validate<T>(options: unknown, optionsDefs: OptionsDefs<T>, path?: string, opts?: ValidateOptions): ValidationResult<T>;
/**
 ...
 */
export declare function enterprise(validatorOrDefs: Validator): Validator;
export declare function enterprise<T extends OptionsDefs<any>>(validatorOrDefs: T): T;
/**
 ...
 */
export declare function deprecated(validator: Validator, message: string): Validator;
export declare function deprecated<T extends OptionsDefs<any>>(validatorOrDefs: T, message: string): T;
/**

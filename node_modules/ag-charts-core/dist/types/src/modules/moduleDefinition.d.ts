...
export interface ModuleDefinition<TModule extends ModuleType = ModuleType, TOptions = any, TInstance extends ModuleInstance = ModuleInstance> {
    ...
    validate?(this: void, options: unknown, optionsDefs: OptionsDefs<TOptions>, path: string, opts?: ValidateOptions): ValidationResult<TOptions>;
}
...
export interface AxisModuleDefinition<TOptions, TInstance extends ModuleInstance = ModuleInstance> extends ModuleDefinition<ModuleType.Axis, TOptions, TInstance> {
...
export interface PluginModuleDefinition<TOptions, TRegistry = unknown> extends ModuleDefinition<ModuleType.Plugin, TOptions> {
    readonly chartType?: string;
    register?(this: void, ctx: DynamicContext<TRegistry>): void;
}
export interface AxisPluginModuleDefinition<TOptions> extends ModuleDefinition<ModuleType.AxisPlugin, TOptions, AxisPluginModuleInstance> {
    readonly chartType?: string;

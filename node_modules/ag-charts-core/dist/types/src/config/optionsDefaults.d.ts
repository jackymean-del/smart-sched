import type { AgBarHighlightStyleOptions, AgGradientColor, AgGradientColorBounds, AgGradientType, AgHighlightStyleOptions, AgImageFill, AgLineHighlightStyleOptions, AgPatternColor, AgSelectionStyleOptions, AgSeriesLineSegmentOptions, AgSeriesShapeSegmentOptions, BorderOptions, CssColor, FillCssOptions, FillOptions, LabelBoxOptions, LineDashOptions, StrokeOptions, TextOptions } from 'ag-charts-types';
...
export declare const colorScaleOptionsDef: import("../state/validation").Validator;
...
export declare const fillCssOptionsDef: OptionsDefs<FillCssOptions>;
...
export declare const shapeSelectionOptionsDef: OptionsDefs<AgSelectionStyleOptions>;
export declare const selectionContainmentValidator: import("../state/validation").Validator;
...
export declare function selectionOptionsDef<T>(itemSelectionOptionsDef: T): {
    enabled: import("../state/validation").Validator;
    containment: import("../state/validation").Validator;
    selectedItem: T;
    unselectedItem: T;
    unselectedSeries: T;
};
...
export declare const textWrap: import("../state/validation").Validator;
export declare const textAlign: import("../state/validation").Validator;
export declare const overflowStrategy: import("../state/validation").Validator;

 ...
 */
export type NormalisedGradientLegendLabelOptions<TContext = ContextDefault> = Normalised<AgGradientLegendLabelOptions<TContext>, 'color' | 'fontSize' | 'fontFamily' | 'fontWeight' | 'minSpacing', {
    fontFamily: string;
}>;
/**

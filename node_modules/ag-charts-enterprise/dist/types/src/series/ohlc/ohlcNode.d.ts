...
export declare class OhlcBaseNode<D = unknown> extends Path<D> implements DistantObject {
    centerX: number;
    __centerX: number;
    y: number;
    __y: number;
     ...
     */
    setStaticProperties(centerX: number, width: number, y: number, height: number, yOpen: number, yClose: number, crisp: boolean): void;
...
export declare class OhlcNode<D = unknown> extends OhlcBaseNode<D> {
    strokeAlignment: number;
    __strokeAlignment: number;
    updatePath(): void;
}
export {};

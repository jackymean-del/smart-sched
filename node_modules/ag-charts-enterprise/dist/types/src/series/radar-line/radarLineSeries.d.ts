...
export declare class RadarLineSeries extends RadarSeries<S, O, P> {
    ...
    protected makeStylerParams(highlightStateEnum: _ModuleSupport.HighlightState | undefined, selectionStateEnum: _ModuleSupport.SelectionState | undefined): AgRadarLineSeriesStylerParams;

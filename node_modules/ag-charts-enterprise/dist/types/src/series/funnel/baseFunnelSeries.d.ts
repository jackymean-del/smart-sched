import { type AgFunnelSeriesStyle, type SelectionState, type TextOrSegments, _ModuleSupport } from 'ag-charts-community';
...
export interface FunnelAnimationData<TNode extends _ModuleSupport.QuadtreeCompatibleNode<FunnelNodeDatum>> extends _ModuleSupport.CartesianAnimationData<FunnelNodeDatum, TNode, FunnelNodeLabelDatum, FunnelContext> {
}
declare class FunnelSeriesNodeEvent<TEvent extends string = _ModuleSupport.SeriesNodeEventTypes> extends _ModuleSupport.SeriesNodeEvent<FunnelNodeDatum, TEvent> {
    ...
    constructor(type: TEvent, nativeEvent: Event, datum: FunnelNodeDatum, series: BaseFunnelSeries<BaseFunnelSeriesTypes>, selectionState: SelectionState | undefined);
}
export declare abstract class BaseFunnelSeries<TTypes extends BaseFunnelSeriesTypes> extends _ModuleSupport.AbstractBarSeries<TTypes> {
    ...
    protected connectorSelection: _ModuleSupport.Selection<FunnelConnectorDatum, FunnelConnector<FunnelConnectorDatum>>;
    ...
    }): _ModuleSupport.Selection<FunnelNodeDatum, _ModuleSupport.NodeOf<TTypes>>;
    ...
    }): _ModuleSupport.Selection<FunnelNodeLabelDatum, _ModuleSupport.Text<FunnelNodeLabelDatum>>;
    ...
    protected resetAllAnimation(data: _ModuleSupport.CartesianAnimationData<FunnelNodeDatum, _ModuleSupport.NodeOf<TTypes>, FunnelNodeLabelDatum, FunnelContext>): void;

...
import { type ChartAnimationPhase, type DynamicContext, type PlacedLabel, type Point } from 'ag-charts-core';
...
export declare class MapMarkerSeries extends TopologySeries<MapMarkerNodeDatum, AgMapMarkerSeriesOptions, MapMarkerSeriesProperties, MapMarkerNodeLabelDatum, MapMarkerNodeDataContext> implements ITopology {
    ...
    private resolveDataColumns;
    private prepareProjectedGeometries;
    private calculateMarkerSize;
    ...
    updatePlacedLabelData(labelData: PlacedLabel<MapMarkerNodeLabelDatum>[]): void;
    private updateLabelNodes;
    private getHighlightedLabelId;

import { type AgActiveItemState, type FillOptions, type LineDashOptions, type SelectionState, type StrokeOptions, _ModuleSupport } from 'ag-charts-community';
...
export declare class FlowProportionSeriesNodeEvent<TEvent extends string = _ModuleSupport.SeriesNodeEventTypes> extends _ModuleSupport.SeriesNodeEvent<_ModuleSupport.SeriesNodeDatum<FlowProportionNodeDatumIndex>, TEvent> {
    ...
    constructor(type: TEvent, nativeEvent: Event, datum: _ModuleSupport.SeriesNodeDatum<FlowProportionNodeDatumIndex>, series: _ModuleSupport.ISeries<FlowProportionNodeDatumIndex, _ModuleSupport.SeriesNodeDatum<FlowProportionNodeDatumIndex>, _ModuleSupport.ISeriesProperties, unknown> & {
        contextNodeData?: _ModuleSupport.SeriesNodeDataContext<FlowProportionNodeDatumIndex, TDatum<FlowProportionNodeDatum<any, any>, FlowProportionLinkDatum<any, any>>, _ModuleSupport.ISeriesProperties>;
    }, selectionState: SelectionState | undefined);
}
export declare abstract class FlowProportionSeries<TNodeDatum extends FlowProportionNodeDatum<TNodeDatum, TLinkDatum>, TLinkDatum extends FlowProportionLinkDatum<TNodeDatum, TLinkDatum>, TLabel, TOpts extends object, TProps extends FlowProportionSeriesProperties<TOpts>, TNode extends _ModuleSupport.Node<TNodeDatum> & DistantObject, TLink extends _ModuleSupport.Node<TLinkDatum> & DistantObject> extends Series<FlowProportionNodeDatumIndex, TDatum<TNodeDatum, TLinkDatum>, TOpts, TProps, TLabel, _ModuleSupport.SeriesNodeDataContext<FlowProportionNodeDatumIndex, TDatum<TNodeDatum, TLinkDatum>, TLabel>> {
    ...
    linkSelection: _ModuleSupport.Selection<TLinkDatum, TLink>;
    nodeSelection: _ModuleSupport.Selection<TNodeDatum, TNode>;

...
export declare class SunburstSeries extends _ModuleSupport.HierarchySeries<SunburstNode, _ModuleSupport.Sector<SunburstNode>, AgSunburstSeriesOptions, SunburstSeriesProperties> {
    ...
    readonly datumSelection: _ModuleSupport.Selection<SunburstNode, _ModuleSupport.Sector<SunburstNode>>;
    ...
    protected getItemStyle(nodeDatum: SunburstNode, isHighlight: boolean): Partial<AgSunburstSeriesOptions<any, unknown> & {
        ...
        opacity: number;
    } & Partial<AgSunburstSeriesOptions<any, unknown> & {
        fill: import("ag-charts-community").AgColorType;
        fillOpacity: number;
        stroke: string;
        strokeWidth: number;

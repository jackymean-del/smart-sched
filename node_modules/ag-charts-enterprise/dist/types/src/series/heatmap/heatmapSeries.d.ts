import type { AgHeatmapSeriesOptions, AgHeatmapSeriesStyle, FontStyle, FontWeight, SelectionState, TextAlign, TextOrSegments, VerticalAlign } from 'ag-charts-community';
import { _ModuleSupport } from 'ag-charts-community';
import { ChartAxisDirection, type DomainWithMetadata, type DynamicContext, type Point, type SizedPoint } from 'ag-charts-core';
...
export declare class HeatmapSeries extends _ModuleSupport.CartesianSeries<HeatmapSeriesTypes> {
    ...
    protected getItemStyle({ datumIndex, datum, colorValue }: Partial<HeatmapNodeDatum>, isHighlight: boolean, highlightState?: _ModuleSupport.HighlightState): Partial<AgHeatmapSeriesOptions<any, unknown> & {
        ...
        opacity: number;
    }> & Partial<AgHeatmapSeriesOptions<any, unknown> & {
        fill: import("ag-charts-community").AgColorType;
        fillOpacity: number;
        stroke: string;
        strokeWidth: number;

...
export declare function prepareLinearGaugeSeriesAnimationFunctions(initialLoad: boolean, horizontal: boolean): {
    node: _ModuleSupport.FromToFns<RectAnimationParams, _ModuleSupport.Rect<RectAnimationParams>, AnimatableRectDatum & Record<string, string | number | undefined>>;
};
...
export declare function formatLinearGaugeLabels(series: _ModuleSupport.Series<_ModuleSupport.DatumIndexType, any, object, any>, ctx: Ctx, selection: _ModuleSupport.Selection<LinearGaugeLabelDatum, _ModuleSupport.Text<LinearGaugeLabelDatum>>, opts: {
    padding: number;
    horizontal: boolean;
}, bboxes: {

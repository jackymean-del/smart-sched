...
import { AbstractModuleInstance, type DynamicContext, Padding } from 'ag-charts-core';
import { MiniChartGroup } from './shapes/miniChartGroup';
declare class MiniChartPadding {
    top: number;
    bottom: number;
}
export declare class MiniChart extends AbstractModuleInstance {

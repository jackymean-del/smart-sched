...
type NavigatorDOMProxyModuleContext = Pick<_ModuleSupport.ChartRegistry, 'zoomManager' | 'proxyInteractionService' | 'localeManager' | 'contextMenuRegistry'>;

...
import { BaseProperties, type DynamicContext, EventEmitter, PropertiesArray } from 'ag-charts-core';
...
export declare class AnnotationOptionsToolbar extends BaseProperties {
    ...
    private textSizeMenuMinWidth?;
    private lineStyleTypeMenuMinWidth?;
    private lineStrokeWidthMenuMinWidth?;
    constructor(ctx: DynamicContext<_ModuleSupport.ChartRegistry>, getActiveDatum: () => AnnotationProperties | undefined);
    private onDragStart;
    private onDragEnd;
    destroy(): void;
    show(): void;

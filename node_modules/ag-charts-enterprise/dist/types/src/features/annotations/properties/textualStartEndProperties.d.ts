...
declare const TextualStartEndProperties_base: {
    new (...args: any[]): {
        localeManager?: import("packages/ag-charts-community/dist/types/src/module-support").LocaleManager | undefined;
        setLocaleManager(localeManager: import("packages/ag-charts-community/dist/types/src/module-support").LocaleManager): void;
    };
} & {
    new (...args: any[]): {

...
import { BaseProperties, type DynamicContext } from 'ag-charts-core';
...
export declare function Localisable<T extends Constructor>(Parent: T): {
    new (...args: any[]): {
        localeManager?: _ModuleSupport.LocaleManager | undefined;
        setLocaleManager(localeManager: DynamicContext<_ModuleSupport.ChartRegistry>['localeManager']): void;
    };
} & T;

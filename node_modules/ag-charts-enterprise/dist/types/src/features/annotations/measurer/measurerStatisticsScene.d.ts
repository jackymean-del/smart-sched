...
import { type Bounds4, type DynamicContext, type Point } from 'ag-charts-core';
...
export declare class MeasurerStatisticsScene extends _ModuleSupport.Group {
    ...
    constructor();
    update(datum: MeasurerTypeProperties, stats: Statistics, anchor: Point, coords: Bounds4, context: AnnotationContext, verticalDirection?: 'up' | 'down', localeManager?: DynamicContext<_ModuleSupport.ChartRegistry>['localeManager']): void;

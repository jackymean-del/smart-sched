...
export declare abstract class TextualPointScene<Datum extends TextualPointProperties> extends PointScene<Datum> {
    activeHandle?: string;
    protected readonly label: _ModuleSupport.Text<unknown>;
    ...
    protected getTextBBox(datum: Datum, coords: Point, _context: AnnotationContext): _ModuleSupport.BBox;
    protected updateLabel(datum: Datum, bbox: BoxBounds, context: AnnotationContext): void;
    protected updateShape(_datum: Datum, _bbox: BoxBounds): void;
    protected updateAnchor(_datum: Datum, bbox: BoxBounds, context: AnnotationContext): {
        x: number;
        y: number;
    ...
    protected getHandleCoords(_datum: Datum, _coords: Point, bbox: _ModuleSupport.BBox): Point;

...
export declare abstract class ChannelScene<Datum extends {
    ...
    protected topLine: CollidableLine<unknown>;
    protected bottomLine: CollidableLine<unknown>;
    background: _ModuleSupport.Path<unknown>;

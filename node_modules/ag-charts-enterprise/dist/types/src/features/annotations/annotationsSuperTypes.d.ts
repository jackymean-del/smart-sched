...
export interface AnnotationTypeConfig<Datum extends BaseProperties, Scene extends AnnotationScene> {
    ...
    translate: (node: AnnotationSceneNode<unknown>, datum: BaseProperties, translation: Point, context: AnnotationContext) => void;
    copy: (node: AnnotationSceneNode<unknown>, datum: BaseProperties, copiedDatum: BaseProperties, context: AnnotationContext) => Datum | undefined;

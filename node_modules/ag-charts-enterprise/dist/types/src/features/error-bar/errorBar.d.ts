...
import { AbstractModuleInstance, ChartAxisDirection, type PickNodeDatumResult, type Point, type PropertyDefinitionOpts, type SeriesPluginModuleInstance } from 'ag-charts-core';
import { ErrorBarProperties } from './errorBarProperties';
export declare class ErrorBars extends AbstractModuleInstance implements SeriesPluginModuleInstance {

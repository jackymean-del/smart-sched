...
import type { HighlightState, SelectionState } from 'ag-charts-types';
...
export declare class ErrorBarNode extends _ModuleSupport.Group<ErrorBarNodeDatum> {
    ...
    update(style: AgErrorBarThemeableOptions, formatters: FormatOptions, caller: Caller, highlightState: HighlightState, selectionState: SelectionState | undefined): void;
    updateBBoxes(): void;

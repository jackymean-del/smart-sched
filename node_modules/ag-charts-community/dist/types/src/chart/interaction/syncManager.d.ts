...
export type SyncChartLike = {
    ...
    getTooltipContent(series: ISeries<DatumIndexType, unknown, ISeriesProperties>, datumIndex: unknown, removeThisDatum: unknown, purpose: 'aria-label' | 'tooltip'): TooltipContent[];

...
export declare class Marker<D = unknown> extends Marker_base {
    __scalingCenterX: number;
    __scalingCenterY: number;
    get datum(): D | undefined;
    set datum(d: D | undefined);
    get previousDatum(): D | undefined;

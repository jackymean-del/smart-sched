...
export type QuadtreeCompatibleNode<D> = Node<D> & DistantObject & {
    readonly midPoint: {
        x: number;
        y: number;
    };
};
export declare function addHitTestersToQuadtree<TDatum extends SeriesNodeDatum<DatumIndexType>, TNode extends QuadtreeCompatibleNode<TDatum>>(quadtree: QuadtreeNearest<TDatum>, hitTesters: Iterable<TNode>): void;

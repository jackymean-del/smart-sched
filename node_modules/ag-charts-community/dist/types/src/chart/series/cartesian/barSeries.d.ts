import type { DomainWithMetadata, DynamicContext, Point, Scale } from 'ag-charts-core';
...
import { type BarSeriesDataAggregationFilter } from './barAggregation';
...
export declare class BarSeries extends AbstractBarSeries<BarSeriesTypes> {
    ...
    getSeriesRange(direction: ChartAxisDirection, visibleRange: [number, number]): [number, number] | [];
     ...
     */
    protected createNodeDatumContext(xAxis: ChartAxis, yAxis: ChartAxis): BarSeriesNodeDatumContext | undefined;
    /**
     ...
     */
    protected populateNodeData(ctx: BarSeriesNodeDatumContext): void;
    /**
     * Creates the initial result context object.
     * Note: segments is undefined here - it's computed in assembleResult.
     */
    protected initializeResult(ctx: BarSeriesNodeDatumContext): BarSeriesNodeDataContext;
    /**
     * Finalizes node data by trimming incremental arrays.
     * BarSeries has multiple arrays: nodes, phantomNodes, and labels.
     */
    protected finalizeNodeData(ctx: BarSeriesNodeDatumContext): void;
    /**
     * Assembles the final result by computing segments.
     */
    protected assembleResult(ctx: BarSeriesNodeDatumContext, result: BarSeriesNodeDataContext): BarSeriesNodeDataContext;
    protected nodeFactory(): BarShape<BarNodeDatum>;
    ...
    }): Selection<BarNodeDatum, BarShape<BarNodeDatum>>;
    ...
    }): Selection<BarNodeDatum, BarShape<any>>;
    ...
    }): Selection<BarNodeDatum, Text<BarNodeDatum>>;
    ...
    protected resetDatumAnimation(data: CartesianAnimationData<BarNodeDatum, BarShape<BarNodeDatum>, BarNodeDatum, BarSeriesNodeDataContext>): void;
    animateReadyHighlight(data: Selection<BarNodeDatum, BarShape<BarNodeDatum>>): void;

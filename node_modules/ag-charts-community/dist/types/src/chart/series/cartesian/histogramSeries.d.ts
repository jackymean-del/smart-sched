...
export declare class HistogramSeries extends CartesianSeries<HistogramSeriesTypes> {
    ...
    }): Selection<HistogramNodeDatum, Text<HistogramNodeDatum>>;

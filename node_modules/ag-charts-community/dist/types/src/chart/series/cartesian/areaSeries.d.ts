import type { DomainWithMetadata, DynamicContext, InternalAgColorType } from 'ag-charts-core';
...
export declare class AreaSeries extends CartesianSeries<AreaSeriesTypes> {
    ...
    protected createBucketLookupFeature(): BucketLookupFeature;
    ...
    }): Selection<MarkerSelectionDatum, Marker<MarkerSelectionDatum>>;
    ...
    }): Selection<LabelSelectionDatum, Text<LabelSelectionDatum>>;
    protected updateLabelNodes(opts: {
        labelSelection: Selection<LabelSelectionDatum, Text<LabelSelectionDatum>>;
        isHighlight?: boolean;
    }): void;
    makeStylerParams(highlightStateEnum: HighlightState | undefined, selectionStateEnum: SelectionState | undefined): AgAreaSeriesStylerParams<unknown, unknown>;
    ...
    protected nodeFactory(): Marker<MarkerSelectionDatum>;
    getStyle(highlightState: HighlightState | undefined): Required<AgAreaSeriesStylerResult> & {

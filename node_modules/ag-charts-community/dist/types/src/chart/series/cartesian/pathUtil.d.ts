...
export declare function pathFadeInAnimation<D>({ id }: {
    id: string;
}, subId: string, animationManager: AnimationManager, phase?: 'add' | 'trailing', ...selection: Selection<D, Path<D>>[] | Path<D>[]): void;

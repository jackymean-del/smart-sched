...
export declare function preparePieSeriesAnimationFunctions(initialLoad: boolean, rotationDegrees: number, scaleFn: ScaleFn, oldScaleFn: ScaleFn): {
    nodes: {
        toFn: FromToMotionPropFn<AnimatableSectorDatum, Sector<AnimatableSectorDatum>, any>;
        fromFn: FromToMotionPropFn<AnimatableSectorDatum, Sector<AnimatableSectorDatum>, any>;
    };
    innerCircle: {
        fromFn: FromToMotionPropFn<{
            radius: number;
        }, Marker<{
            radius: number;
        }>, {
            size: number;
            phase?: "update" | "initial" | undefined;
        }>;
        toFn: FromToMotionPropFn<{
            radius: number;
        }, Marker<{
            radius: number;
        }>, {

...
import type { AgDonutSeriesOptions, AgDonutSeriesStyle, AgPieSeriesStyle, SelectionState, TextOrSegments } from 'ag-charts-types';
...
declare class PieDonutSeriesNodeEvent<TEvent extends string = SeriesNodeEventTypes> extends SeriesNodeEvent<PieDonutNodeDatum, TEvent> {
    ...
    constructor(type: TEvent, nativeEvent: Event, datum: PieDonutNodeDatum, series: DonutSeries, selectionState: SelectionState | undefined);
}
...
export declare class DonutSeries extends PolarSeries<PieDonutNodeDatum, AgDonutSeriesOptions, DonutSeriesProperties, Sector<PieDonutNodeDatum>> {
    static readonly className: string;
    static readonly type: string;
    properties: DonutSeriesProperties;
    private phantomNodeData;
    private get calloutNodeData();
    readonly backgroundGroup: TranslatableGroup<unknown>;
    ...
    readonly zerosumOuterRing: Marker<unknown>;
    readonly zerosumInnerRing: Marker<unknown>;
    readonly innerLabelsGroup: Group<unknown>;
    readonly innerCircleGroup: Group<unknown>;
    readonly innerLabelsSelection: Selection<DonutInnerLabel<any>, Text<DonutInnerLabel<any>>>;
    readonly innerCircleSelection: Selection<any, Marker<{
        radius: number;
    }>>;
    ...
    protected nodeFactory(): Sector<PieDonutNodeDatum>;

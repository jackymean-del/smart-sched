import { type DomainWithMetadata, type NormalizedDomain, type ScaleTickParams, type ScaleTickResult } from 'ag-charts-core';
...
export declare class OrdinalTimeScale extends DiscreteTimeScale {
    ...
    private _uniformityCacheVisibleStart;
    private _uniformityCacheVisibleEnd;
    private _uniformityCacheVisible;

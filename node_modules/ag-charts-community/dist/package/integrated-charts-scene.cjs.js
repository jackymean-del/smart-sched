...
var Group = _Group;
var ScalableGroup = Scalable(Group);
var RotatableGroup = Rotatable(Group);
var TranslatableGroup = Translatable(Group);
var TransformableGroup = Rotatable(
  Translatable(Group)
);
...
var Text = _Text;
var RotatableText = Rotatable(Text);
var TransformableText = Rotatable(Translatable(Text));

// packages/ag-charts-community/src/chart/caption.ts
var CaptionTooltipProperties = class extends import_ag_charts_core26.BaseProperties {
};
__decorateClass([
  import_ag_charts_core26.Property
], CaptionTooltipProperties.prototype, "visible", 2);
__decorateClass([
  import_ag_charts_core26.Property
], CaptionTooltipProperties.prototype, "text", 2);
__decorateClass([
  import_ag_charts_core26.Property
], CaptionTooltipProperties.prototype, "renderer", 2);
var Caption = class extends import_ag_charts_core26.BaseProperties {
  ...
  getTooltipContent(moduleCtx) {
    const captionText = (0, import_ag_charts_core26.toPlainText)(this.text);
    const { renderer, text } = this.tooltip;
    if (renderer != null) {
      const params = { text: captionText };
      const result = (0, import_ag_charts_core26.callWithContext)(moduleCtx.chartService, renderer, params);
      if (result === "")
        return void 0;
      if (result != null)
        return { type: "raw", rawHtmlString: (0, import_ag_charts_core26.toTextString)(result) };
    }
...
var ImageLoader = class extends import_ag_charts_core33.EventEmitter {
  ...
  loadImage(uri, affectedNode) {
    ...
    const ImageCtor = (0, import_ag_charts_core33.getImage)();

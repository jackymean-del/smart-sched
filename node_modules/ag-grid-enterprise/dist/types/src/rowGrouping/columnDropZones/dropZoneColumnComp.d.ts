...
export declare class DropZoneColumnComp extends PillDragComp<AgColumn> {
    ...
    private readonly updateParams?;
    private readonly eSortIndicator;
    private readonly deferApply;
    private displayName;
    private popupShowing;
    constructor(column: AgColumn, dragSourceDropTarget: DropTarget, ghost: boolean, dropZonePurpose: TDropZone, horizontal: boolean, updateParams?: ColumnStateUpdateParams | undefined);
    postConstruct(): void;
    getItem(): AgColumn;
    ...
    private setupSort;
    private getCurrentSortDirection;
    private getSortDefOverride;

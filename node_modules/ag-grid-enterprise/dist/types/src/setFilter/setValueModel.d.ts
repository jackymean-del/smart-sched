...
export declare class SetValueModel<TValue> extends BeanStub<SetValueModelEvent> {
    private readonly csrmValuesExtractor;
    ...
    private initialised;
    constructor(csrmValuesExtractor: CsrmValuesExtractor<TValue> | undefined, caseFormat: <T extends string | null>(valueToFormat: T) => T, createKey: (value: TValue | null | undefined, node?: RowNode) => string | null, isTreeDataOrGrouping: () => boolean, params: SetValueModelParams<TValue>);
    postConstruct(): void;
